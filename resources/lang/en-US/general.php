...
return [
    ...
    'age'                   => "Age",
    'all_assets'			=> 'All Files',
    'all'       			=> 'All',
    'archived'              => 'Archived',
    'asset_models'			=> 'File Models',
    'asset_model'			=> 'Model',
    'asset'					=> 'File',
    'asset_previous'        => 'File (Previously Assigned)',
    'asset_report'          => 'File Report',
    'asset_tag'				=> 'File Tag',
    'asset_tags'            => 'File Tags',
    'available'		        => 'Available',
    'assets_available'		=> 'Files available',
    'accept_assets'         => 'Accept Files :name',
    'accept_assets_menu'    => 'Accept Files',
    ...
    'assets'				=> 'Files',
    'assets_audited'        => 'files audited',
    'assets_checked_in_count'     => 'files checked in',
    'assets_checked_out_count'     => 'files checked out',
    'asset_deleted_warning'     => 'This file has been deleted. You must restore it before you can assign it to someone.',
    ...
    'custom_report'         => 'Custom File Report',
    'dashboard'				=> 'Dashboard',
    ...
    'error'				    => 'Error',
    'exclude_archived'      => 'Exclude Archived Files',
    'exclude_deleted'       => 'Exclude Deleted Files',
    'example'				=> 'Example: ',
    'files'                 => 'Files',
    'file_name'				=> 'File Name',
    'file_type'             => 'File Type',
    ...
    'asset_maintenance'        => 'File Maintenance',
    'asset_maintenance_report' => 'File Maintenance Report',
    'asset_maintenances'       => 'File Maintenances',
    'item'  				=> 'Item',
    'item_name'             => 'Item Name',
    ...
    'logout'				=> 'Logout',
    'lookup_by_tag'     => 'Lookup by File Tag',
    ...
    'next_audit_date_help'  => 'If you use auditing in your organization, this is usually automatically calculated based on the file&apos;s last audit date and audit frequency (in <code>Admin Settings &gt; Alerts</code>) and you can leave this blank. You can manually set this date here if you need to, but it must be later than the last audit date. ',
    'audit_images_help'     => 'You can find audit images in the file\'s history tab.',
    ...
    'only_deleted'          => 'Only Deleted Files',
    ...
    'requested_assets'      => 'Requested Files',
    ...
    'audit_due_days'        => '{}Files Due or Overdue for Audit|[1]Files Due or Overdue for Audit Within a Day|[2,*]Files Due or Overdue for Audit Within :days Days',
    'audit_due_days_view_all' => '{}Files Due or Overdue for Audit|[1]View All Files Due or Overdue for Audit Within a Day|[2,*]View All Files Due or Overdue for Audit Within :days Days',
    'checkin_due'           => 'Due for Checkin',
    'checkin_overdue'       => 'Overdue for Checkin',
    'checkin_due_days'      => '{}Due for Checkin|[1]Files Due for Checkin Within :days Day|[2,*]Files Due for Checkin Within :days Days',
    ...
    'to'                    => 'To',
    'to_user'               => 'To',
    'report_fields_info'    => '<p>Select the fields you would like to include in your custom report, and click Generate. The file (custom-file-report-YYYY-mm-dd.csv) will download automatically, and you can open it in Excel.</p>
            <p>If you would like to export only certain files, use the options below to fine-tune your results.</p>',
    'range'                 => 'Range',
    ...
    'dashboard_empty'       => 'It looks like you have not added anything yet, so we do not have anything awesome to display. Get started by adding some files, accessories, consumables, or licenses now!',
    'new_asset'             => 'New File',
    ...
    'asset_information'     => 'File Information',
    ...
    'checkin_to_diff_location' => 'You can choose to check this file in to a location other than this file\'s default location of :default_location if one is set',
    ...
    'shitty_browser'        => 'No signature detected. If you are using an older browser, please use a more modern browser to complete your file acceptance.',
    ...
    'assets_by_status'      => 'Files by Status',
    'assets_by_status_type'      => 'Files by Status Type',
    ...
    'merge_information' =>  'This will merge the :count users into a single user. Select the user you wish to merge the others into below, and the associated files, licenses, etc will be moved over to the selected user and the other users will be marked as deleted.',
    ...
    'auto_incrementing_asset_tags_disabled_so_tags_required' => 'Generating auto-incrementing file tags is disabled so all rows need to have the "File Tag" column populated.',
    'auto_incrementing_asset_tags_enabled_so_now_assets_will_be_created' => 'Note: Generating auto-incrementing file tags is enabled so files will be created for rows that do not have "File Tag" populated. Rows that do have "File Tag" populated will be updated with the provided information.',
    ...
    'theme' => 'Theme',
    'error_user_company' => 'Checkout target company and file company do not match',
    'error_user_company_multiple' => 'One or more of the checkout target company and file company do not match',
    'error_user_company_accept_view' => 'A File assigned to you belongs to a different company so you can\'t accept nor deny it, please check with your manager',
    'error_assets_already_checked_out' => 'One or more of the files are already checked out',
    'assigned_assets_removed' => 'The following were removed from the selected files because they are already checked out',
    'importer' => [
        ...
        'checked_out_to_tag' => 'Checked Out to: File Tag',
    ...
    'copied' => 'Copied!',
    'status_compatibility' => 'If files are already assigned, they cannot be changed to a non-deployable status type and this value change will be skipped.',
    'rtd_location_help' => 'This is the location of the file when it is not checked out',
    ...
    'no_requestable' => 'There are no requestable files or file models.',

    'countable' => [
        'accessories'  => ':count Accessory|:count Accessories',
        'assets'  => ':count File|:count Files',
    ...
    'more_info' => 'More Info',
    'quickscan_bulk_help' => 'Checking this box will edit the file record to reflect this new location. Leaving it unchecked will simply note the location in the audit log. Note that if this file is checked out, it will not change the location of the person, file or location it is checked out to.',
    'whoops' => 'Whoops!',
    ...
    'label' => 'Label',
    'import_asset_tag_exists' => 'A file with the file tag :asset_tag already exists and an update was not requested. No change was made.',
...
// Add form placeholders here
    ...
    'bulk_delete_associations' => [
        ...
        'assoc_assets'                => ':item_name is currently associated with :asset_count file(s) and cannot be deleted. Please update your files to no longer reference this :item and try again.',
        'asset_models'                => ':item_name is currently associated with :asset_count file(s) and cannot be deleted. Please update your file models to no longer reference this :item and try again.',
        ...
        'assoc_assets_no_count'       => ':item_name is currently associated with other files and cannot be deleted. Please update your files to no longer reference this :item and try again.',
        'asset_models_no_count'       => ':item_name is currently associated with other file models and cannot be deleted. Please update your files to no longer reference this :item and try again.',
    ...
    'deleted_models' => 'Deleted File Models',
