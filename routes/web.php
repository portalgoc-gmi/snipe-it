...
Route::group(['middleware' => 'auth'], function () {
    ...
    */
	...
	Route::get('/account/accept-delivery/{asset}', [App\Http\Controllers\Account\DeliveryAcceptController::class, 'show'])
    ->name('account.delivery.accept');

	Route::post('/account/accept-delivery/{asset}', [App\Http\Controllers\Account\DeliveryAcceptController::class, 'store'])
    ->name('account.delivery.accept.store');
...
Route::middleware('auth')->group(function () {
	...
	Route::get('/returns/rows', [\App\Http\Controllers\ReturnsController::class, 'rows'])
	->name('returns.rows');
